import { _Proxy as _Proxy_, _Reflect as _Reflect_, snapshot, _WeakMap as _WeakMap_, _WeakMap_prototype as _WeakMap_prototype_, } from "@portal-solutions/hooker-core";
...
export function create({ _Proxy = _Proxy_, globalThis = globalThis_, _WeakMap = _WeakMap_, _WeakMap_prototype = _WeakMap_prototype_, _Reflect = _Reflect_, } = {}) {
    return class Zone {
